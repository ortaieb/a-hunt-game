...
describe("ChallengesOrchestrator", () => {
  ...
  describe("registerScheduledCallback", () => {
    it("should register callback for future challenge", () => {
      ...
      const result = orchestrator.registerScheduledCallback(
        challengeId,
        startTime,
      );
    ...
    it("should use custom callback when provided", () => {
      ...
      orchestrator.registerScheduledCallback(
        challengeId,
        startTime,
        customCallback,
      );
    ...
    it("should return false for duplicate registration", () => {
      ...
      const result1 = orchestrator.registerScheduledCallback(
        challengeId,
        startTime,
      );
      const result2 = orchestrator.registerScheduledCallback(
        challengeId,
        startTime,
      );
  ...
  describe("scheduleAllFutureChallenges", () => {
    ...
    it("should use custom callback when provided", async () => {
      ...
      const scheduledCount =
        orchestrator.scheduleAllFutureChallenges(customCallback);
